-- Source: https://wiki.warframe.com/index.php?title=Module:Weapons/data/secondary&action=raw
-- Mirror license: CC-BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
-- Mirrored: 2026-05-27T12:39:28.649Z
		...
		Attacks = {
			{
				...
				CritMultiplier = 2,
				Damage = { Heat = 150 },
				Falloff = { EndRange = 2, Reduction = 1.00, StartRange = 0 },
				FireRate = 1.67,
				IsSilent = false,
				MaxSpread = 7,
				MinSpread = 1.5,
