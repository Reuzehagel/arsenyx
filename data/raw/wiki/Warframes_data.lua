-- Source: https://wiki.warframe.com/index.php?title=Module:Warframes/data&action=raw
-- Mirror license: CC-BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)
-- Mirrored: 2026-05-29T15:07:40.701Z
...
return {
	...
	Warframes = {
		...
		["Voruna Prime"] = {
			...
			Energy = 130,
			FullImages = { { TabName = "Profile", Image = "VorunaPrime.png" } },
			Health = 455,
