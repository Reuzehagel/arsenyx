  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        >
          <Plus className="text-muted-foreground/20 group-hover:text-muted-foreground/40 size-6 transition-colors" />
          {/* Label */}
          <span className="text-muted-foreground/50 mt-1 font-mono text-[10px] tracking-wider uppercase">
            Arcane
          </span>
        </TooltipTrigger>
